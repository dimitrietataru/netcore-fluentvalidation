...
### Install
``` powershell
PM> Install-Package FluentValidation -Version 9.1.2
PM> Install-Package FluentValidation.AspNetCore -Version 9.1.2
PM> Install-Package FluentValidation.DependencyInjectionExtensions -Version 9.1.2
```
